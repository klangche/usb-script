...
The tool asks only two questions:
...
Supported Platforms
Platform,Without admin,With admin/sudo,Detail Level
Windows (PowerShell),Basic tree,Improved tree,Good
Linux,Full tree (lsusb -t),Full + extra,Excellent
macOS,Full tree (system_profiler),Full,Excellent
Windows + Git Bash,Full tree (via bash),Full,Excellent
